...
* Contributors:
*
* Description:            Provides the TAknFepUiInputStateInitialLatinJapanese definition.
*
*/
...
#ifndef __AKN_FEP_UI_INPUT_STATE_INIT_FULL_LATIN_H__
#define __AKN_FEP_UI_INPUT_STATE_INIT_FULL_LATIN_H__
 ...
 *  @since 2.6
 */
class TAknFepUiInputStateInitialLatinJapanese
...
public: // onstructors and destructor
     ...
     */
    TAknFepUiInputStateInitialLatinJapanese(
...
#endif //__AKN_FEP_UI_INPUT_STATE_INIT_FULL_LATIN_H__
