...
#ifndef __PTI_LANGUAGES_ITUT_103_H__
#define __PTI_LANGUAGES_ITUT_103_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Galician 
//
class CPtiLangDataImplGalician : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplGalician* NewL();
