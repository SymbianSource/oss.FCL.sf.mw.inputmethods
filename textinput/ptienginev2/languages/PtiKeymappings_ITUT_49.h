...
#ifndef __PTI_LANGUAGES_ITUT_49_H__
#define __PTI_LANGUAGES_ITUT_49_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Estonian 
//
class CPtiLangDataImplEstonian : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplEstonian* NewL();
