...
//
const TUint16 MultitapData_table_Norwegian[] =
    {
...
const TInt KMultitapDataSize_Norwegian = 199;


const TPtiKeyBinding MultitapKeyBindings_table_Norwegian[] =
    {
...
const TInt KMaxMultitapIndex_Norwegian = 24;
...
//
const TUint16 MiniQwertyData_table_Norwegian[] =
    {
     0x0071,
     0x0077,
...
const TInt KMiniQwertyDataSize_Norwegian = 155;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Norwegian[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
...
const TInt KMaxMiniQwertyIndex_Norwegian = 84;

//
// MiniQwerty3x11 keymap data table
//
const TUint16 MiniQwerty3x11Data_table_Norwegian[] =
    {
     0x0071,
     0x0077,
     0x0065,0x00E9,0x00E8,0x00EB,0x00EA,
...
const TInt KMiniQwerty3x11DataSize_Norwegian = 139;


const TPtiKeyBinding MiniQwerty3x11KeyBindings_table_Norwegian[] =
    {
...
const TInt KMaxMiniQwerty3x11Index_Norwegian = 86;

//
// Class implementation.
//

CPtiLangDataImplNorwegian* CPtiLangDataImplNorwegian::NewL()
    {
    return new (ELeave) CPtiLangDataImplNorwegian();
    }


TInt CPtiLangDataImplNorwegian::LanguageCode() const
    {
    return ELangNorwegian;
    }


const TUint16* CPtiLangDataImplNorwegian::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Norwegian;
        return MultitapData_table_Norwegian;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Norwegian;
        return StandardQwertyData_table_Norwegian;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Norwegian;
        return MiniQwertyData_table_Norwegian;
        }

    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aDataSize = KMiniQwerty3x11DataSize_Norwegian;
        return MiniQwerty3x11Data_table_Norwegian;
        }
...
const TPtiKeyBinding* CPtiLangDataImplNorwegian::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Norwegian;
        return MultitapKeyBindings_table_Norwegian;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Norwegian;
        return StandardQwertyKeyBindings_table_Norwegian;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Norwegian;
        return MiniQwertyKeyBindings_table_Norwegian;
        }
    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aNumItems = KMaxMiniQwerty3x11Index_Norwegian;
        return MiniQwerty3x11KeyBindings_table_Norwegian;
        }
