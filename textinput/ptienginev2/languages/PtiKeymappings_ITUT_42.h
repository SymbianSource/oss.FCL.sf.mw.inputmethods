...
#ifndef __PTI_LANGUAGES_ITUT_42_H__
#define __PTI_LANGUAGES_ITUT_42_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Bulgarian 
//
class CPtiLangDataImplBulgarian : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplBulgarian* NewL();
