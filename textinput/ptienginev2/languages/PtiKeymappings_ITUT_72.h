...
#ifndef __PTI_LANGUAGES_ITUT_72_H__
#define __PTI_LANGUAGES_ITUT_72_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Marathi 
//
class CPtiLangDataImplMarathi : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplMarathi* NewL();
