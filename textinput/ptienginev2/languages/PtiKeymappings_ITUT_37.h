...
#ifndef __PTI_LANGUAGES_ITUT_37_H__
#define __PTI_LANGUAGES_ITUT_37_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Arabic 
//
class CPtiLangDataImplArabic : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplArabic* NewL();
