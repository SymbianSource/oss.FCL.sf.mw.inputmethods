...
#ifndef __PTI_LANGUAGES_ITUT_29_H__
#define __PTI_LANGUAGES_ITUT_29_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language TaiwanChinese 
//
class CPtiLangDataImplTaiwanChinese : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplTaiwanChinese* NewL();
