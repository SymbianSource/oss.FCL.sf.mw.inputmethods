...
//
const TUint16 MultitapData_table_Galician[] =
    {
     ...
     0x6d,0x6e,0xf1,0x6f,0x36,0xf3,0xba,0xf6,0xf4,0xf2,0xf5,0xf8,
     ...
     0x4d,0x4e,0xd1,0x4f,0x36,0xd3,0xba,0xd6,0xd4,0xd2,0xd5,0xd8,
...
const TInt KMultitapDataSize_Galician = 203;


const TPtiKeyBinding MultitapKeyBindings_table_Galician[] =
    {
...
const TInt KMaxMultitapIndex_Galician = 24;
...
//
const TUint16 MiniQwertyData_table_Galician[] =
    {
     0x0071,
     0x0077,
...
const TInt KMiniQwertyDataSize_Galician = 160;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Galician[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
...
const TInt KMaxMiniQwertyIndex_Galician = 83;

//
// Class implementation.
//

CPtiLangDataImplGalician* CPtiLangDataImplGalician::NewL()
    {
    return new (ELeave) CPtiLangDataImplGalician();
    }


TInt CPtiLangDataImplGalician::LanguageCode() const
    {
    return KLangGalician;
    }


const TUint16* CPtiLangDataImplGalician::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Galician;
        return MultitapData_table_Galician;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Galician;
        return StandardQwertyData_table_Galician;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Galician;
        return MiniQwertyData_table_Galician;
        }
...
const TPtiKeyBinding* CPtiLangDataImplGalician::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Galician;
        return MultitapKeyBindings_table_Galician;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Galician;
        return StandardQwertyKeyBindings_table_Galician;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Galician;
        return MiniQwertyKeyBindings_table_Galician;
        }
...
const TUint16* CPtiLangDataImplGalician::DeadKeyDataArray(TPtiKeyboardType aKeyboardType, TInt& aNumRowsInArray) const
    {
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumRowsInArray = KStandardQwertyDeadKeyTableRows_Galician;
        return StandardQwertyDeadKeyData_table_Galician;
        }
