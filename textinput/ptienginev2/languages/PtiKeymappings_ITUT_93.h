...
#ifndef __PTI_LANGUAGES_ITUT_93_H__
#define __PTI_LANGUAGES_ITUT_93_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Ukrainian 
//
class CPtiLangDataImplUkrainian : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplUkrainian* NewL();
