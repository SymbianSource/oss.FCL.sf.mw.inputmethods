...
#ifndef __PTI_LANGUAGES_ITUT_58_H__
#define __PTI_LANGUAGES_ITUT_58_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Hindi 
//
class CPtiLangDataImplHindi : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplHindi* NewL();
