...
//
const TUint16 MultitapData_table_Slovak[] =
    {
...
const TInt KMultitapDataSize_Slovak = 215;


const TPtiKeyBinding MultitapKeyBindings_table_Slovak[] =
    {
...
const TInt KMaxMultitapIndex_Slovak = 24;
...
//
const TUint16 MiniQwertyData_table_Slovak[] =
    {
     0x0071,
     0x0077,
     ...
     0x0075,0x00FA,0x016F,0x00FC,0x0171,0x00F9,0x00FB,
     0x0069,0x00ED,0x00EE,
     0x006F,0x00F4,0x00F3,0x00F6,0x0151,
     0x0070,
     ...
     0x0055,0x00DA,0x016E,0x00DC,0x0170,0x00D9,0x00DB,
     0x0049,0x00CD,0x00CE,
     0x004F,0x00D4,0x00D3,0x00D6,0x0150,
     0x0050,
...
const TInt KMiniQwertyDataSize_Slovak = 178;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Slovak[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
        ...
        {EPtiKeyQwerty3, EPtiCaseUpper, 77, 4},
        {EPtiKeyQwerty4, EPtiCaseUpper, 81, 3},
        {EPtiKeyQwerty5, EPtiCaseUpper, 84, 3},
        {EPtiKeyQwerty6, EPtiCaseUpper, 87, 4},
        {EPtiKeyQwerty7, EPtiCaseUpper, 91, 7},
        {EPtiKeyQwerty8, EPtiCaseUpper, 98, 3},
        {EPtiKeyQwerty9, EPtiCaseUpper, 101, 5},
        {EPtiKeyQwerty0, EPtiCaseUpper, 106, 1},
        {EPtiKeyQwertyA, EPtiCaseUpper, 107, 6},
        {EPtiKeyQwertyS, EPtiCaseUpper, 113, 4},
        {EPtiKeyQwertyD, EPtiCaseUpper, 117, 3},
        ...
        {EPtiKeyQwertyL, EPtiCaseUpper, 125, 4},
        {EPtiKeyQwertyZ, EPtiCaseUpper, 129, 2},
        {EPtiKeyQwertyX, EPtiCaseUpper, 131, 1},
        {EPtiKeyQwertyC, EPtiCaseUpper, 132, 3},
        {EPtiKeyQwertyV, EPtiCaseUpper, 135, 1},
        {EPtiKeyQwertyB, EPtiCaseUpper, 136, 1},
        {EPtiKeyQwertyN, EPtiCaseUpper, 137, 3},
        {EPtiKeyQwertyM, EPtiCaseUpper, 140, 1},
        {EPtiKeyQwertyComma, EPtiCaseUpper, 141, 1},
        {EPtiKeyQwertyFullstop, EPtiCaseUpper, 142, 1},
        {EPtiKeyQwerty1, EPtiCaseFnLower, 145, 1},
        {EPtiKeyQwerty2, EPtiCaseFnLower, 146, 1},
        {EPtiKeyQwerty3, EPtiCaseFnLower, 147, 1},
        {EPtiKeyQwerty4, EPtiCaseFnLower, 148, 1},
        {EPtiKeyQwerty5, EPtiCaseFnLower, 149, 1},
        {EPtiKeyQwerty6, EPtiCaseFnLower, 150, 1},
        {EPtiKeyQwerty7, EPtiCaseFnLower, 151, 1},
        {EPtiKeyQwerty8, EPtiCaseFnLower, 152, 1},
        {EPtiKeyQwerty9, EPtiCaseFnLower, 153, 1},
        {EPtiKeyQwertyA, EPtiCaseFnLower, 154, 1},
        {EPtiKeyQwertyS, EPtiCaseFnLower, 155, 1},
        {EPtiKeyQwertyD, EPtiCaseFnLower, 156, 1},
        {EPtiKeyQwertyF, EPtiCaseFnLower, 157, 1},
        {EPtiKeyQwertyG, EPtiCaseFnLower, 158, 1},
        {EPtiKeyQwertyH, EPtiCaseFnLower, 159, 1},
        {EPtiKeyQwertyJ, EPtiCaseFnLower, 160, 1},
        {EPtiKeyQwertyK, EPtiCaseFnLower, 161, 1},
        {EPtiKeyQwertyL, EPtiCaseFnLower, 162, 1},
        {EPtiKeyQwertyZ, EPtiCaseFnLower, 163, 1},
        {EPtiKeyQwertyX, EPtiCaseFnLower, 164, 1},
        {EPtiKeyQwertyC, EPtiCaseFnLower, 165, 1},
        {EPtiKeyQwertyV, EPtiCaseFnLower, 166, 1},
        {EPtiKeyQwertyB, EPtiCaseFnLower, 167, 1},
        {EPtiKeyQwertyN, EPtiCaseFnLower, 168, 1},
        {EPtiKeyQwertyM, EPtiCaseFnLower, 169, 1},
        {EPtiKeyQwertyComma, EPtiCaseFnLower, 170, 1},
        {EPtiKeyQwertyFullstop, EPtiCaseFnLower, 171, 1},
    };

const TInt KMaxMiniQwertyIndex_Slovak = 83;


//
// Dead key data table for MiniQwerty
//
const TUint16 MiniQwertyDeadKeyData_table_Slovak[] =
    {
    2,  0x00E9,0x00EA,0x011B,0xF000,0xF000,
    3,  0x0155,0xF000,0x0159,0xF000,0xF000,
    4,  0xF000,0xF000,0x0165,0xF000,0xF000,
    5,  0x017A,0xF000,0x017E,0xF000,0xF000,
    6,  0x00FA,0x00FB,0xF000,0xF000,0xF000,
    7,  0x00ED,0x00EE,0xF000,0xF000,0xF000,
    8,  0x00F3,0x00F4,0xF000,0xF000,0xF000,
    10,  0x00E1,0x00E2,0xF000,0xF000,0xF000,
    11,  0x015B,0xF000,0x0161,0xF000,0xF000,
    12,  0xF000,0xF000,0x010F,0xF000,0xF000,
    18,  0x013A,0xF000,0x013E,0xF000,0xF000,
    19,  0x00FD,0xF000,0xF000,0xF000,0xF000,
    21,  0x0107,0xF000,0x010D,0xF000,0xF000,
    24,  0x0144,0xF000,0x0148,0xF000,0xF000,
    34,  0x00C9,0x00CA,0x011A,0xF000,0xF000,
    35,  0x0154,0xF000,0x0158,0xF000,0xF000,
    36,  0xF000,0xF000,0x0164,0xF000,0xF000,
    37,  0x0179,0xF000,0x017D,0xF000,0xF000,
    38,  0x00DA,0x00DB,0xF000,0xF000,0xF000,
    39,  0x00CD,0x00CE,0xF000,0xF000,0xF000,
    40,  0x00D3,0x00D4,0xF000,0xF000,0xF000,
    42,  0x00C1,0x00C2,0xF000,0xF000,0xF000,
    43,  0x015A,0xF000,0x0160,0xF000,0xF000,
    44,  0xF000,0xF000,0x010E,0xF000,0xF000,
    50,  0x0139,0xF000,0x013D,0xF000,0xF000,
    51,  0x00DD,0xF000,0xF000,0xF000,0xF000,
    53,  0x0106,0xF000,0x010C,0xF000,0xF000,
    56,  0x0143,0xF000,0x0147,0xF000,0xF000,
    };

const TInt KMiniQwertyDeadKeyTableRows_Slovak = 28;

//
// MiniQwerty3x11 keymap data table
//
const TUint16 MiniQwerty3x11Data_table_Slovak[] =
    {
     0x0071,
     0x0077,
     0x0065,0x011B,0x00E9,0x0119,
...
const TInt KMiniQwerty3x11DataSize_Slovak = 173;


const TPtiKeyBinding MiniQwerty3x11KeyBindings_table_Slovak[] =
    {
        ...
        {EPtiKeyQwertyComma, EPtiCaseUpper, 122, 1},
        ...
        {EStdKeySpace, EPtiCaseUpper, 135, 0},
        {EPtiKeyQwertyQ, EPtiCaseFnLower, 135, 1},
        {EPtiKeyQwertyW, EPtiCaseFnLower, 136, 1},
        {EPtiKeyQwertyE, EPtiCaseFnLower, 137, 1},
        {EPtiKeyQwertyR, EPtiCaseFnLower, 138, 1},
        {EPtiKeyQwertyT, EPtiCaseFnLower, 139, 1},
        {EPtiKeyQwertyY, EPtiCaseFnLower, 140, 1},
        {EPtiKeyQwertyU, EPtiCaseFnLower, 141, 1},
        {EPtiKeyQwertyI, EPtiCaseFnLower, 142, 1},
        {EPtiKeyQwertyO, EPtiCaseFnLower, 143, 1},
        {EPtiKeyQwertyP, EPtiCaseFnLower, 144, 1},
        {EPtiKeyQwertyA, EPtiCaseFnLower, 145, 1},
        {EPtiKeyQwertyS, EPtiCaseFnLower, 146, 1},
        {EPtiKeyQwertyD, EPtiCaseFnLower, 147, 1},
        {EPtiKeyQwertyF, EPtiCaseFnLower, 148, 1},
        {EPtiKeyQwertyG, EPtiCaseFnLower, 149, 1},
        {EPtiKeyQwertyH, EPtiCaseFnLower, 150, 1},
        {EPtiKeyQwertyJ, EPtiCaseFnLower, 151, 1},
        {EPtiKeyQwertyK, EPtiCaseFnLower, 152, 1},
        {EPtiKeyQwertyL, EPtiCaseFnLower, 153, 1},
        {EPtiKeyQwertyComma, EPtiCaseFnLower, 154, 1},
        ...
        {EPtiKeyQwertyA, EPtiCaseFnUpper, 162, 1},
        {EPtiKeyQwertyS, EPtiCaseFnUpper, 163, 1},
        {EPtiKeyQwertyD, EPtiCaseFnUpper, 164, 1},
        {EPtiKeyQwertyK, EPtiCaseFnUpper, 165, 1},
        {EPtiKeyQwertyL, EPtiCaseFnUpper, 166, 1},
        {EPtiKeyQwertyComma, EPtiCaseFnUpper, 167, 1},
        {EPtiKeyQwertyZ, EPtiCaseFnUpper, 168, 1},
        {EPtiKeyQwertyX, EPtiCaseFnUpper, 169, 1},
        {EPtiKeyQwertyC, EPtiCaseFnUpper, 170, 1},
        {EPtiKeyQwertyN, EPtiCaseFnUpper, 171, 1},
        {EPtiKeyQwertyM, EPtiCaseFnUpper, 172, 1},
    };

const TInt KMaxMiniQwerty3x11Index_Slovak = 94;

//
// Class implementation.
//

CPtiLangDataImplSlovak* CPtiLangDataImplSlovak::NewL()
    {
    return new (ELeave) CPtiLangDataImplSlovak();
    }


TInt CPtiLangDataImplSlovak::LanguageCode() const
    {
    return ELangSlovak;
    }


const TUint16* CPtiLangDataImplSlovak::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Slovak;
        return MultitapData_table_Slovak;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Slovak;
        return StandardQwertyData_table_Slovak;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Slovak;
        return MiniQwertyData_table_Slovak;
        }

    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aDataSize = KMiniQwerty3x11DataSize_Slovak;
        return MiniQwerty3x11Data_table_Slovak;
        }
...
const TPtiKeyBinding* CPtiLangDataImplSlovak::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Slovak;
        return MultitapKeyBindings_table_Slovak;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Slovak;
        return StandardQwertyKeyBindings_table_Slovak;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Slovak;
        return MiniQwertyKeyBindings_table_Slovak;
        }
    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aNumItems = KMaxMiniQwerty3x11Index_Slovak;
        return MiniQwerty3x11KeyBindings_table_Slovak;
        }
...
const TUint16* CPtiLangDataImplSlovak::DeadKeyDataArray(TPtiKeyboardType aKeyboardType, TInt& aNumRowsInArray) const
    {
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumRowsInArray = KStandardQwertyDeadKeyTableRows_Slovak;
        return StandardQwertyDeadKeyData_table_Slovak;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumRowsInArray = KMiniQwertyDeadKeyTableRows_Slovak;
        return MiniQwertyDeadKeyData_table_Slovak;
        }
