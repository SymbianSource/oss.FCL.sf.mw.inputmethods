...
*
* Description:           
*       Provides the TAknFepUiInputStateCompletionPredictiveHiraganaKanji definition.
*
*/
...
#ifndef __AKN_FEP_UI_INPUT_STATE_COMPLETION_PREDICTIVE_HIRAGANA_KANJI_H__
#define __AKN_FEP_UI_INPUT_STATE_COMPLETION_PREDICTIVE_HIRAGANA_KANJI_H__
 ...
 *  @since 2.6
 */
class TAknFepUiInputStateCompletionPredictiveHiraganaKanji
