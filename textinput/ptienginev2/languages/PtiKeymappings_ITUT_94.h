...
#ifndef __PTI_LANGUAGES_ITUT_94_H__
#define __PTI_LANGUAGES_ITUT_94_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Urdu 
//
class CPtiLangDataImplUrdu : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplUrdu* NewL();
