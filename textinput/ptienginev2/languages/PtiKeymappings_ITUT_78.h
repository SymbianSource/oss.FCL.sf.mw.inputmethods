...
#ifndef __PTI_LANGUAGES_ITUT_78_H__
#define __PTI_LANGUAGES_ITUT_78_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Romanian 
//
class CPtiLangDataImplRomanian : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplRomanian* NewL();
