...
#ifndef __PTI_LANGUAGES_ITUT_31_H__
#define __PTI_LANGUAGES_ITUT_31_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language PrcChinese 
//
class CPtiLangDataImplPrcChinese : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplPrcChinese* NewL();
