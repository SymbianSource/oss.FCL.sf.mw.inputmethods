...
//
const TUint16 MultitapData_table_Basque[] =
    {
...
const TInt KMultitapDataSize_Basque = 203;


const TPtiKeyBinding MultitapKeyBindings_table_Basque[] =
    {
...
const TInt KMaxMultitapIndex_Basque = 24;
...
//
const TUint16 MiniQwertyData_table_Basque[] =
    {
     0x0071,
     0x0077,
...
const TInt KMiniQwertyDataSize_Basque = 160;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Basque[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
...
const TInt KMaxMiniQwertyIndex_Basque = 83;

//
// Class implementation.
//

CPtiLangDataImplBasque* CPtiLangDataImplBasque::NewL()
    {
    return new (ELeave) CPtiLangDataImplBasque();
    }


TInt CPtiLangDataImplBasque::LanguageCode() const
    {
    return KLangBasque;
    }


const TUint16* CPtiLangDataImplBasque::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Basque;
        return MultitapData_table_Basque;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Basque;
        return StandardQwertyData_table_Basque;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Basque;
        return MiniQwertyData_table_Basque;
        }
...
const TPtiKeyBinding* CPtiLangDataImplBasque::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Basque;
        return MultitapKeyBindings_table_Basque;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Basque;
        return StandardQwertyKeyBindings_table_Basque;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Basque;
        return MiniQwertyKeyBindings_table_Basque;
        }
...
const TUint16* CPtiLangDataImplBasque::DeadKeyDataArray(TPtiKeyboardType aKeyboardType, TInt& aNumRowsInArray) const
    {
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumRowsInArray = KStandardQwertyDeadKeyTableRows_Basque;
        return StandardQwertyDeadKeyData_table_Basque;
        }
