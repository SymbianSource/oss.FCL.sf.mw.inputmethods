...
//
const TUint16 MultitapData_table_Tagalog[] =
    {
     ...
     0x6d,0x6e,0x6f,0x36,0xf1,0xf6,0xf8,0xf2,0xf3,0xf4,0xf5,
     ...
     0x4d,0x4e,0x4f,0x36,0xd1,0xd6,0xd8,0xd2,0xd3,0xd4,0xd5,
...
const TInt KMultitapDataSize_Tagalog = 195;


const TPtiKeyBinding MultitapKeyBindings_table_Tagalog[] =
    {
        ...
        {EPtiKey2, EPtiCaseUpper, 128, 12},
        {EPtiKey3, EPtiCaseUpper, 140, 9},
        {EPtiKey4, EPtiCaseUpper, 149, 8},
        {EPtiKey5, EPtiCaseUpper, 157, 5},
        {EPtiKey6, EPtiCaseUpper, 162, 11},
        {EPtiKey7, EPtiCaseUpper, 173, 6},
...
const TInt KMaxMultitapIndex_Tagalog = 24;
...
//
const TUint16 MiniQwertyData_table_Tagalog[] =
    {
     0x0071,
     0x0077,
     ...
     0x0070,
     0x0061,0x0061,0x00E4,0x00E6,0x00E5,0x00E0,0x00E1,0x00E2,0x00E3,
     0x0073,0x00DF,
     0x0064,0x00F0,
     0x0066,
     0x0067,0x011F,
     ...
     0x0050,
     0x0041,0x00C4,0x00C6,0x00C5,0x00C0,0x00C1,0x00C2,0x00C3,
     0x0053,
     0x0044,0x00D0,
     0x0046,
     0x0047,0x011E,
...
const TInt KMiniQwertyDataSize_Tagalog = 157;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Tagalog[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
        ...
        {EPtiKeyQwertyA, EPtiCaseLower, 30, 9},
        ...
        {EPtiKeyQwerty9, EPtiCaseUpper, 87, 7},
        {EPtiKeyQwerty0, EPtiCaseUpper, 94, 1},
        {EPtiKeyQwertyA, EPtiCaseUpper, 95, 8},
        {EPtiKeyQwertyS, EPtiCaseUpper, 103, 1},
        {EPtiKeyQwertyD, EPtiCaseUpper, 104, 2},
        {EPtiKeyQwertyF, EPtiCaseUpper, 106, 1},
        {EPtiKeyQwertyG, EPtiCaseUpper, 107, 2},
        ...
        {EPtiKeyQwertyC, EPtiCaseUpper, 115, 2},
        {EPtiKeyQwertyV, EPtiCaseUpper, 117, 1},
        {EPtiKeyQwertyB, EPtiCaseUpper, 118, 1},
        {EPtiKeyQwertyN, EPtiCaseUpper, 119, 2},
        {EPtiKeyQwertyM, EPtiCaseUpper, 121, 1},
        {EPtiKeyQwertyComma, EPtiCaseUpper, 122, 1},
        {EPtiKeyQwertyFullstop, EPtiCaseUpper, 123, 1},
        {EPtiKeyQwerty1, EPtiCaseFnLower, 124, 1},
        {EPtiKeyQwerty2, EPtiCaseFnLower, 125, 1},
        {EPtiKeyQwerty3, EPtiCaseFnLower, 126, 1},
        {EPtiKeyQwerty4, EPtiCaseFnLower, 127, 1},
        {EPtiKeyQwerty5, EPtiCaseFnLower, 128, 1},
        {EPtiKeyQwerty6, EPtiCaseFnLower, 129, 1},
        {EPtiKeyQwerty7, EPtiCaseFnLower, 130, 1},
        {EPtiKeyQwerty8, EPtiCaseFnLower, 131, 1},
        {EPtiKeyQwerty9, EPtiCaseFnLower, 132, 1},
        {EPtiKeyQwertyA, EPtiCaseFnLower, 133, 1},
        {EPtiKeyQwertyS, EPtiCaseFnLower, 134, 1},
        {EPtiKeyQwertyD, EPtiCaseFnLower, 135, 1},
        {EPtiKeyQwertyF, EPtiCaseFnLower, 136, 1},
        {EPtiKeyQwertyG, EPtiCaseFnLower, 137, 1},
        {EPtiKeyQwertyH, EPtiCaseFnLower, 138, 1},
        {EPtiKeyQwertyJ, EPtiCaseFnLower, 139, 1},
        {EPtiKeyQwertyK, EPtiCaseFnLower, 140, 1},
        {EPtiKeyQwertyL, EPtiCaseFnLower, 141, 1},
        {EPtiKeyQwertyZ, EPtiCaseFnLower, 142, 1},
        {EPtiKeyQwertyX, EPtiCaseFnLower, 143, 1},
        {EPtiKeyQwertyC, EPtiCaseFnLower, 144, 1},
        {EPtiKeyQwertyV, EPtiCaseFnLower, 145, 1},
        {EPtiKeyQwertyB, EPtiCaseFnLower, 146, 1},
        {EPtiKeyQwertyN, EPtiCaseFnLower, 147, 1},
        {EPtiKeyQwertyM, EPtiCaseFnLower, 148, 1},
        {EPtiKeyQwertyComma, EPtiCaseFnLower, 149, 1},
        {EPtiKeyQwertyFullstop, EPtiCaseFnLower, 150, 1},
    };

const TInt KMaxMiniQwertyIndex_Tagalog = 83;

//
// Class implementation.
//

CPtiLangDataImplTagalog* CPtiLangDataImplTagalog::NewL()
    {
    return new (ELeave) CPtiLangDataImplTagalog();
    }


TInt CPtiLangDataImplTagalog::LanguageCode() const
    {
    return ELangTagalog;
    }


const TUint16* CPtiLangDataImplTagalog::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Tagalog;
        return MultitapData_table_Tagalog;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Tagalog;
        return StandardQwertyData_table_Tagalog;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Tagalog;
        return MiniQwertyData_table_Tagalog;
        }
...
const TPtiKeyBinding* CPtiLangDataImplTagalog::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Tagalog;
        return MultitapKeyBindings_table_Tagalog;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Tagalog;
        return StandardQwertyKeyBindings_table_Tagalog;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Tagalog;
        return MiniQwertyKeyBindings_table_Tagalog;
        }
