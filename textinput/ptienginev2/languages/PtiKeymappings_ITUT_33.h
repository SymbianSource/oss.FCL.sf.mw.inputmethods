...
#ifndef __PTI_LANGUAGES_ITUT_33_H__
#define __PTI_LANGUAGES_ITUT_33_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Thai 
//
class CPtiLangDataImplThai : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplThai* NewL();
