...
//
const TUint16 MultitapData_table_Swedish[] =
    {
...
const TInt KMultitapDataSize_Swedish = 197;


const TPtiKeyBinding MultitapKeyBindings_table_Swedish[] =
    {
        ...
        {EPtiKey9, EPtiCaseLower, 89, 7},
        {EPtiKeyStar, EPtiCaseLower, 96, 0},
        {EPtiKey0, EPtiCaseLower, 96, 3},
        {EPtiKeyHash, EPtiCaseLower, 99, 0},
        {EPtiKey1, EPtiCaseUpper, 99, 30},
        {EPtiKey2, EPtiCaseUpper, 129, 12},
        {EPtiKey3, EPtiCaseUpper, 141, 9},
        {EPtiKey4, EPtiCaseUpper, 150, 8},
        {EPtiKey5, EPtiCaseUpper, 158, 4},
        {EPtiKey6, EPtiCaseUpper, 162, 11},
        {EPtiKey7, EPtiCaseUpper, 173, 6},
        {EPtiKey8, EPtiCaseUpper, 179, 8},
        {EPtiKey9, EPtiCaseUpper, 187, 7},
        {EPtiKeyStar, EPtiCaseUpper, 194, 0},
        {EPtiKey0, EPtiCaseUpper, 194, 3},
        {EPtiKeyHash, EPtiCaseUpper, 197, 0},
    };

const TInt KMaxMultitapIndex_Swedish = 24;
...
//
const TUint16 MiniQwertyData_table_Swedish[] =
    {
     0x0071,
     0x0077,
...
const TInt KMiniQwertyDataSize_Swedish = 155;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Swedish[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
...
const TInt KMaxMiniQwertyIndex_Swedish = 84;

//
// MiniQwerty3x11 keymap data table
//
const TUint16 MiniQwerty3x11Data_table_Swedish[] =
    {
     0x0071,
     0x0077,
     0x0065,0x00E9,0x00E8,0x00EB,0x00EA,
...
const TInt KMiniQwerty3x11DataSize_Swedish = 139;


const TPtiKeyBinding MiniQwerty3x11KeyBindings_table_Swedish[] =
    {
...
const TInt KMaxMiniQwerty3x11Index_Swedish = 86;

//
// Class implementation.
//

CPtiLangDataImplSwedish* CPtiLangDataImplSwedish::NewL()
    {
    return new (ELeave) CPtiLangDataImplSwedish();
    }


TInt CPtiLangDataImplSwedish::LanguageCode() const
    {
    return ELangSwedish;
    }


const TUint16* CPtiLangDataImplSwedish::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Swedish;
        return MultitapData_table_Swedish;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Swedish;
        return StandardQwertyData_table_Swedish;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Swedish;
        return MiniQwertyData_table_Swedish;
        }

    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aDataSize = KMiniQwerty3x11DataSize_Swedish;
        return MiniQwerty3x11Data_table_Swedish;
        }
...
const TPtiKeyBinding* CPtiLangDataImplSwedish::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Swedish;
        return MultitapKeyBindings_table_Swedish;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Swedish;
        return StandardQwertyKeyBindings_table_Swedish;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Swedish;
        return MiniQwertyKeyBindings_table_Swedish;
        }
    if (aKeyboardType == EPtiKeyboardQwerty3x11)
        {
        aNumItems = KMaxMiniQwerty3x11Index_Swedish;
        return MiniQwerty3x11KeyBindings_table_Swedish;
        }
