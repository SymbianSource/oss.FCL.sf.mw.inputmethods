...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::NewL
// ---------------------------------------------------------------------------
//
CChnSplitItutUiStateStrokeZhuyinComposition* CChnSplitItutUiStateStrokeZhuyinComposition::NewL(
    CSplitItutUiMgrBase* aOwner)
    {
    CChnSplitItutUiStateStrokeZhuyinComposition* self = 
        new (ELeave) CChnSplitItutUiStateStrokeZhuyinComposition(aOwner);
...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::~CChnSplitItutUiStateStrokeZhuyinComposition
// ---------------------------------------------------------------------------
//
CChnSplitItutUiStateStrokeZhuyinComposition::~CChnSplitItutUiStateStrokeZhuyinComposition()
    {
...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::OnEntryL
// ---------------------------------------------------------------------------
//
void CChnSplitItutUiStateStrokeZhuyinComposition::OnEntryL()
    {
    /*
...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::OnExit
// ---------------------------------------------------------------------------
//
void CChnSplitItutUiStateStrokeZhuyinComposition::OnExit()
    {
    /*
...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::HandleKeyL
// ---------------------------------------------------------------------------
//
TBool CChnSplitItutUiStateStrokeZhuyinComposition::HandleKeyL(TInt /*aCmd*/, TInt /*aKey*/)
    {
    /*
    TInt immode = iOwner->DataMgr()->InputMode();
...
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::StateType
// ---------------------------------------------------------------------------
//
CSplitItutUiMgrBase::TUiState CChnSplitItutUiStateStrokeZhuyinComposition::StateType()
    {
    return CSplitItutUiMgrBase::EStateComposition;
    }
    
// ---------------------------------------------------------------------------
// CChnSplitItutUiStateStrokeZhuyinComposition::HandleCtrlEventL
// ---------------------------------------------------------------------------
//
TBool CChnSplitItutUiStateStrokeZhuyinComposition::HandleCtrlEventL(TInt /*aEventType*/, 
