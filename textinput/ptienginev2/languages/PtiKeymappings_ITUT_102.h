...
#ifndef __PTI_LANGUAGES_ITUT_102_H__
#define __PTI_LANGUAGES_ITUT_102_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Basque 
//
class CPtiLangDataImplBasque : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplBasque* NewL();
