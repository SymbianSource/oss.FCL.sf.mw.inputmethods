...
#ifndef __PTI_LANGUAGES_ITUT_44_H__
#define __PTI_LANGUAGES_ITUT_44_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Catalan 
//
class CPtiLangDataImplCatalan : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplCatalan* NewL();
