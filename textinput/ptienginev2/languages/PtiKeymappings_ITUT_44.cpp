...
//
const TUint16 MultitapData_table_Catalan[] =
    {
...
const TInt KMultitapDataSize_Catalan = 203;


const TPtiKeyBinding MultitapKeyBindings_table_Catalan[] =
    {
...
const TInt KMaxMultitapIndex_Catalan = 24;
...
//
const TUint16 MiniQwertyData_table_Catalan[] =
    {
     0x0071,
     0x0077,
...
const TInt KMiniQwertyDataSize_Catalan = 160;


const TPtiKeyBinding MiniQwertyKeyBindings_table_Catalan[] =
    {
        {EPtiKeyQwerty1, EPtiCaseLower, 0, 1},
        {EPtiKeyQwerty2, EPtiCaseLower, 1, 1},
...
const TInt KMaxMiniQwertyIndex_Catalan = 83;

//
// Class implementation.
//

CPtiLangDataImplCatalan* CPtiLangDataImplCatalan::NewL()
    {
    return new (ELeave) CPtiLangDataImplCatalan();
    }


TInt CPtiLangDataImplCatalan::LanguageCode() const
    {
    return ELangCatalan;
    }


const TUint16* CPtiLangDataImplCatalan::KeyData(TPtiKeyboardType aKeyboardType, TInt& aDataSize) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aDataSize = KMultitapDataSize_Catalan;
        return MultitapData_table_Catalan;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aDataSize = KStandardQwertyDataSize_Catalan;
        return StandardQwertyData_table_Catalan;
        }

    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aDataSize = KMiniQwertyDataSize_Catalan;
        return MiniQwertyData_table_Catalan;
        }
...
const TPtiKeyBinding* CPtiLangDataImplCatalan::KeyBindingTable(TPtiKeyboardType aKeyboardType, TInt& aNumItems) const
    {
    if (aKeyboardType == EPtiKeyboard12Key)
        {
        aNumItems = KMaxMultitapIndex_Catalan;
        return MultitapKeyBindings_table_Catalan;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumItems = KMaxStandardQwertyIndex_Catalan;
        return StandardQwertyKeyBindings_table_Catalan;
        }
    if (aKeyboardType == EPtiKeyboardQwerty4x10)
        {
        aNumItems = KMaxMiniQwertyIndex_Catalan;
        return MiniQwertyKeyBindings_table_Catalan;
        }
...
const TUint16* CPtiLangDataImplCatalan::DeadKeyDataArray(TPtiKeyboardType aKeyboardType, TInt& aNumRowsInArray) const
    {
    if (aKeyboardType == EPtiKeyboardQwerty4x12)
        {
        aNumRowsInArray = KStandardQwertyDeadKeyTableRows_Catalan;
        return StandardQwertyDeadKeyData_table_Catalan;
        }
