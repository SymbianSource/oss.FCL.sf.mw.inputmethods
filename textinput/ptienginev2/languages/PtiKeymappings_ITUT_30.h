...
#ifndef __PTI_LANGUAGES_ITUT_30_H__
#define __PTI_LANGUAGES_ITUT_30_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language HongKongChinese 
//
class CPtiLangDataImplHongKongChinese : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplHongKongChinese* NewL();
