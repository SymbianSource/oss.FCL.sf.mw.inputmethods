...
#ifndef __PTI_LANGUAGES_ITUT_50_H__
#define __PTI_LANGUAGES_ITUT_50_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Farsi 
//
class CPtiLangDataImplFarsi : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplFarsi* NewL();
