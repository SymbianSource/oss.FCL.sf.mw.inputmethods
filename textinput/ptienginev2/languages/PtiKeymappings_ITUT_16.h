...
#ifndef __PTI_LANGUAGES_ITUT_16_H__
#define __PTI_LANGUAGES_ITUT_16_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Russian 
//
class CPtiLangDataImplRussian : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplRussian* NewL();
