...
#ifndef __PTI_LANGUAGES_ITUT_57_H__
#define __PTI_LANGUAGES_ITUT_57_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Hebrew 
//
class CPtiLangDataImplHebrew : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplHebrew* NewL();
