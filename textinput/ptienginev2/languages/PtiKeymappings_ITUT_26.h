...
#ifndef __PTI_LANGUAGES_ITUT_26_H__
#define __PTI_LANGUAGES_ITUT_26_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Slovak 
//
class CPtiLangDataImplSlovak : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplSlovak* NewL();
