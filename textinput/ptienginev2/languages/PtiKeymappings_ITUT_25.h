...
#ifndef __PTI_LANGUAGES_ITUT_25_H__
#define __PTI_LANGUAGES_ITUT_25_H__

#include <PtiKeyMapData.h>


//
// Class declaration for language Czech 
//
class CPtiLangDataImplCzech : public CPtiKeyMapData
    {
    public:
        static CPtiLangDataImplCzech* NewL();
